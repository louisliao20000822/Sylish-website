        ...
        try {
            ...
            if (roleId == null) {
                ...
                if (!userDetail) {
                    ...
                    req.user.card = await User.getCard(user.email);
                    req.user.birthday = userDetail.Birthday;
                    req.user.address = userDetail.address;
                    req.user.phone = userDetail.phone;
                    req.user.spend = userDetail.spend;
                    req.user.lineuuid = userDetail.lineuuid;
                    console.log(userDetail.lineuuid);
                    next();
                }
            }
            return;
